...
import { faRulerCombined,faPencilRuler,faStreetView,faPersonBooth,faHelicopter,faHamburger} from '@fortawesome/free-solid-svg-icons'
const LayoutDesign =  <FontAwesomeIcon icon={faRulerCombined} /> ;
const webDesign =  <FontAwesomeIcon icon={faPencilRuler} /> ;
const emailTemplate =  <FontAwesomeIcon icon={faStreetView} /> ;
                 ...
                 <div className="row">
                     ...
                     <div className="col-md-4 col-sm-6 col-12 p-2 ">
                        ...
                        <h1 className="text-warning border-2 p-3 service-icon">{webDesign}</h1>
                         ...
                         <h5 className="fw-bold text-light">Transform the website according to the dynamic design</h5>
                         <p className="text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                     </div>
                     <div className="col-md-4 col-sm-6 col-12 p-2 ">
                        ...
                        <h1 className="text-warning border-2 p-3 service-icon">{emailTemplate}</h1>
                         <h4 className="fw-bold text-warning">3. Web Devolopment</h4>
                         <h5 className="fw-bold text-light">A variety of feature ads, including normal website development</h5>
                         <p className="text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                     </div>
